...
Gem::Specification.new do |s|
  s.name        = 'continuent-tools-cfn'
  s.version     = '0.0.1'
  s.date        = Date.today.to_s
  s.summary     = "Continuent Tungsten tools to build AWS CloudFormation files"
  s.authors     = ["Continuent"]
  s.email       = 'info@continuent.com'
  s.files       = Dir.glob("{bin,lib,includes,templates}/**/*") + %w(LICENSE README.md)
  Dir.glob("bin/*").each{|bin|
    s.executables << File.basename(bin)
  }
  s.homepage    =
    'https://github.com/continuent/continuent-tools-cfn'
